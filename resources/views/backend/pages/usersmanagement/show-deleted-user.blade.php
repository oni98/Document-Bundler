                            ...
                            <div class="col-sm-4 col-md-6">
                                ...
                                @if ($user->profile)
                                    <div class="text-center text-left-tablet mb-4">
                                        {!! Form::model($user, [
                                            'action' => ['SoftDeletesController@update', $user->id],
                                            'method' => 'PUT',
                                            'class' => 'form-inline',
                                        ]) !!}
                                        {!! Form::button('<i class="fa fa-refresh fa-fw" aria-hidden="true"></i> Restore User', [
                                        ...
                                        {!! Form::close() !!}
                                        {!! Form::model($user, [
                                            'action' => ['SoftDeletesController@destroy', $user->id],
                                            'method' => 'DELETE',
                                            'class' => 'form-inline',
                                            'data-toggle' => 'tooltip',
                                        ...
                                        {!! Form::button('<i class="fa fa-user-times fa-fw" aria-hidden="true"></i> Delete User', [
                                            ...
                                            'data-message' => 'Are you sure you want to permanently delete this user?',
                                        ]) !!}
                                        {!! Form::close() !!}
                                    </div>
                                @endif
