                                        ...
                                        <div class="col-12 col-sm-8 col-md-9">
                                            <div class="tab-content" id="v-pills-tabContent">
                                                <div class="tab-pane fade show active edit-profile-tab" role="tabpanel"
                                                        ...
                                                        <div class="col-10 offset-1 col-sm-10 offset-sm-1 mb-1">
                                                            <div class="row" data-toggle="buttons">
                                                                <div class="col-6 col-xs-6 right-btn-container">
                                                                    <label
                                                                        class="btn btn-primary @if ($user->profile->avatar_status == 0) active @endif btn-block btn-sm"
                                                                ...
                                                                <div class="col-6 col-xs-6 left-btn-container">
                                                                    <label
                                                                        class="btn btn-primary @if ($user->profile->avatar_status == 1) active @endif btn-block btn-sm"
                                                                        data-toggle="collapse"
                                                    ...
                                                    {{-- <div
                                                            class="form-group has-feedback {{ $errors->has('theme') ? ' has-error ' : '' }}">
                                                            {!! Form::label('theme_id', trans('profile.label-theme'), ['class' => 'col-12 control-label']) !!}
                                                            <div class="col-12">
                                                                <select class="form-control" name="theme_id" id="theme_id">
                                                                    @if ($themes->count())
                                                                        @foreach ($themes as $theme)
                                                                            <option
                                                                                value="{{ $theme->id }}"{{ $currentTheme->id == $theme->id ? 'selected="selected"' : '' }}>
                                                                                {{ $theme->name }}</option>
                                                                        @endforeach
                                                                    @endif
                                                                </select>
                                                                <span
                                                                    class="glyphicon {{ $errors->has('theme') ? ' glyphicon-asterisk ' : ' ' }} form-control-feedback"
                                                    ...
                                                    <div
                                                        class="form-group has-feedback {{ $errors->has('location') ? ' has-error ' : '' }}">
                                                        {!! Form::label('location', trans('profile.label-location'), ['class' => 'col-12 control-label']) !!}
                                                        <div class="col-12">
                                                            ...
                                                            <span
                                                                class="glyphicon {{ $errors->has('location') ? ' glyphicon-asterisk ' : ' glyphicon-pencil ' }} form-control-feedback"
                                                                aria-hidden="true"></span>
                                                    ...
                                                    <div
                                                        class="form-group has-feedback {{ $errors->has('bio') ? ' has-error ' : '' }}">
                                                        {!! Form::label('bio', trans('profile.label-bio'), ['class' => 'col-12 control-label']) !!}
                                                        <div class="col-12">
                                                    ...
                                                    <div
                                                        class="form-group has-feedback {{ $errors->has('twitter_username') ? ' has-error ' : '' }}">
                                                        {!! Form::label('twitter_username', trans('profile.label-twitter_username'), [
                                                            'class' => 'col-12 control-label',
                                                        ]) !!}
                                                        <div class="col-12">
                                                            {!! Form::text('twitter_username', old('twitter_username'), [
                                                                'id' => 'twitter_username',
                                                                'class' => 'form-control',
                                                    ...
                                                    <div
                                                        class="margin-bottom-2 form-group has-feedback {{ $errors->has('github_username') ? ' has-error ' : '' }}">
                                                        {!! Form::label('github_username', trans('profile.label-github_username'), ['class' => 'col-12 control-label']) !!}
                                                        <div class="col-12">
                                                            {!! Form::text('github_username', old('github_username'), [
                                                                'id' => 'github_username',
                                                                'class' => 'form-control',
                                                    ...
                                                    <div class="form-group margin-bottom-2">
                                                        <div class="col-12">
                                                            {!! Form::button('<i class="fa fa-fw fa-save" aria-hidden="true"></i> ' . trans('profile.submitButton'), [
                                                                'id' => 'confirmFormSave',
                                                ...
                                                <div class="tab-pane fade edit-settings-tab" role="tabpanel"
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-md-9 offset-md-3">
                                                            {!! Form::button('<i class="fa fa-fw fa-save" aria-hidden="true"></i> ' . trans('profile.submitProfileButton'), [
                                                                'class' => 'btn btn-success disabled',
                                                ...
                                                <div class="tab-pane fade edit-account-tab" role="tabpanel"
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div id="changepw" class="tab-pane fade show active">
                                                            ...
                                                            <div class="form-group row">
                                                                <div class="col-md-9 offset-md-3">
                                                                    {!! Form::button('<i class="fa fa-fw fa-save" aria-hidden="true"></i> ' . trans('profile.submitPWButton'), [
                                                        ...
                                                        <div id="deleteAccount" class="tab-pane fade">
                                                            ...
                                                            <div class="row">
                                                                <div
                                                                    ...
                                                                    {!! Form::model($user, ['action' => ['ProfilesController@deleteUserAccount', $user->id], 'method' => 'DELETE']) !!}
                                                                    ...
                                                                    {!! Form::button('<i class="fa fa-trash-o fa-fw" aria-hidden="true"></i> ' . trans('profile.deleteAccountBtn'), [
